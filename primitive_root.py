...
elif isItHasPrimitiveRoot(n) :
    start_time = time.time()
    print "Number Of Primitive Root : ",getNumberOfPrimitiveRoot(n)
    print "Primitive Root : ",getPrimitiveRoot(n)
    end_time = time.time() - start_time
    print "t : ",end_time
else :
    print "It doesn't have to Primitive Root"
